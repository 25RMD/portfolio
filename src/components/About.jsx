...
export default function About() {
  ...
  return (
    <section
      ...
      data-scroll-section
      data-cursor-invert
      className="relative w-full min-h-screen bg-black text-white flex flex-col z-10 py-20 px-8 md:px-12 overflow-x-clip"
    >
      {/* Background Elements */}
      <div 
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col gap-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
          ...
          <div className="flex flex-col gap-8" data-scroll data-scroll-speed="1">
             <div className="group p-6 -mx-6 rounded-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-white/5">
        ...
        <div className="flex flex-col gap-12 mt-12">
            <div className="w-full h-px bg-white/20 reveal-line" data-scroll />
