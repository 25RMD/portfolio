        ...
        >
            ...
            <div className="absolute inset-x-0 bottom-0 flex justify-center z-0 overflow-hidden">
                ...
                >
                    <img
                        ...
                        className="h-[90vh] w-auto object-cover object-bottom select-none transition-transform duration-[800ms]"
                        style={{
            ...
            >
                <img
                    ...
                    className="absolute max-w-none max-h-none object-contain select-none"
            ...
            <div className={`absolute inset-0 z-30 pointer-events-none transition-opacity duration-1000 ${showContent ? 'opacity-100' : 'opacity-0'}`}>
                {/* Name - Top Left (cycles between DANIEL UTHO and 25RMD) */}
                ...
                {/* Tagline - Bottom Left */}
                <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 z-20 pointer-events-auto">
                    <p
